<div class="meu-menu border-bottom border-dark">
    <div class="row">
        ...
        <div class="col-8 itens-menu">
            ...
            <a href="consultas.php" class="link"><span class="menu-item"><img class="icon-menu"src="../imgs/consultas.png"><br>Consultas</span></a>
            <a href="fechar_caixa.php" class="link"><span class="menu-item"><img class="icon-menu"src="../imgs/caixa.png"><br>Fechamento de Caixa</span></a>
            <a href="configuracoes.php" class="link"><span class="menu-item"><img class="icon-menu"src="../imgs/configuracoes.png"><br>Configuracoes</span></a>
        </div>
    </div>
</div>